...
static inline int gvotable_set_compound_result(struct gvotable_election *el, const char *reason,
					       int vote_hi, int vote_lo)
{
	return gvotable_election_set_result(el, reason,
					    (void *)((((long)vote_hi) << 32) | vote_lo));
}
